...
INSTALL_JS_GLOBAL="/home/marcusfreire/src/rascunho/gsd/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/marcusfreire/src/rascunho/gsd/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
