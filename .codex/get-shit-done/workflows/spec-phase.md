...
```bash
INIT=$(node "/home/marcusfreire/src/rascunho/gsd/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/marcusfreire/src/rascunho/gsd/.codex/get-shit-done/templates/spec.md.
