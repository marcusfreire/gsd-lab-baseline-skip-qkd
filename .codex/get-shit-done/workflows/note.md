...
- **Global scope**: `/home/marcusfreire/src/rascunho/gsd/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/marcusfreire/src/rascunho/gsd/.codex/notes/`)
...
2. Glob `/home/marcusfreire/src/rascunho/gsd/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/marcusfreire/src/rascunho/gsd/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/marcusfreire/src/rascunho/gsd/.codex/notes/` — works in any directory
