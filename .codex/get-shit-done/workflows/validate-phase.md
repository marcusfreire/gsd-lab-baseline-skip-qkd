...
```
Agent(
  prompt="Read /home/marcusfreire/src/rascunho/gsd/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/marcusfreire/src/rascunho/gsd/.codex/get-shit-done/templates/VALIDATION.md`
