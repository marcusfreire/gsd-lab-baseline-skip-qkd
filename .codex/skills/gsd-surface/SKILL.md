...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/marcusfreire/src/rascunho/gsd/.codex/.gsd-surface.json`
(sibling to `/home/marcusfreire/src/rascunho/gsd/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/marcusfreire/src/rascunho/gsd/.codex/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/marcusfreire/src/rascunho/gsd/.codex/skills`).
...
`/home/marcusfreire/src/rascunho/gsd/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/marcusfreire/src/rascunho/gsd/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/marcusfreire/src/rascunho/gsd/.codex/.gsd-surface.json`
Install profile marker: `/home/marcusfreire/src/rascunho/gsd/.codex/.gsd-profile`
Skill dirs: `/home/marcusfreire/src/rascunho/gsd/.codex/skills/gsd-*/`
Engine module: `/home/marcusfreire/src/rascunho/gsd/.codex/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/marcusfreire/src/rascunho/gsd/.codex/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
